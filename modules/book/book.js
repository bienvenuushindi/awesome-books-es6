import * as successMsg from './success-msg.js';

export default class Book {
  static list = [];

  static noBookFoundMsg = successMsg.notfound;

  static deleteMsg = successMsg.removed;

  static insertMsg = successMsg.inserted;
